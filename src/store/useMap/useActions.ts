 ...
 * @returns
 */
export function useModuleActions(moduleName: string, mapper: string[]) {
...
export function useActions(moduleName: string, mapper: string[]) {

    return useActionMapper(mapper, mapActions)
}
